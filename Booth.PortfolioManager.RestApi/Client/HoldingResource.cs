...
namespace Booth.PortfolioManager.RestApi.Client
{
    public class HoldingResource
    {
        ...
        {
            var url = "/api/portfolio/" + _MessageHandler.Portfolio + "/holdings?date=" + date.ToIsoDateString();
        ...
        {
            var url = "/api/portfolio/" + _MessageHandler.Portfolio + "/holdings?fromdate=" + dateRange.FromDate.ToIsoDateString() + "&todate=" + dateRange.ToDate.ToIsoDateString();
        ...
        {
            var url = "/api/portfolio/" + _MessageHandler.Portfolio + "/holdings/" + stockId + "?date=" + date.ToIsoDateString();
        ...
        {
            return await _MessageHandler.GetAsync<TransactionsResponse>("/api/portfolio/" + _MessageHandler.Portfolio + "/holdings/" + stockId + "/transactions?fromdate=" + dateRange.FromDate.ToIsoDateString() + "&todate=" + dateRange.ToDate.ToIsoDateString());
        }

        public async Task<SimpleUnrealisedGainsResponse> GetCapitalGains(Guid stockId, Date date)
        {
            return await _MessageHandler.GetAsync<SimpleUnrealisedGainsResponse>("/api/portfolio/" + _MessageHandler.Portfolio + "/holdings/" + stockId + "/capitalgains?date=" + date.ToIsoDateString());
        }

        public async Task<DetailedUnrealisedGainsResponse> GetDetailedCapitalGains(Guid stockId, Date date)
        {
            return await _MessageHandler.GetAsync<DetailedUnrealisedGainsResponse>("/api/portfolio/" + _MessageHandler.Portfolio + "/holdings/" + stockId + "/detailedcapitalgains?date=" + date.ToIsoDateString());
        }

        public async Task<CorporateActionsResponse> GetCorporateActions(Guid stockId)
        {
            return await _MessageHandler.GetAsync<CorporateActionsResponse>("/api/portfolio/" + _MessageHandler.Portfolio + "/holdings/" + stockId + "/corporateactions");
        }
